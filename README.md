...
$
$ cd CORE19-09_quiz_random  ## Entrar en el directorio de trabajo del programa de test
$
...
$             ## El directorio de trabajo contiene ahora el fichero: CORE19-09_quiz_random.zip
```

El fichero `CORE19-09_quiz_random.zip` contiene los ficheros de la practica comprimidos y puede subirse a la plataforma para su evaluación.
